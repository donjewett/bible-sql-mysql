/* *************************************************************************
* Bible Database: MariaDB/MySQL, by Don Jewett
...
CREATE TABLE IF NOT EXISTS Editions (
	Id int NOT NULL AUTO_INCREMENT COMMENT 'Auto-incrementing Id',
	Code varchar(16) CHARACTER SET ascii NOT NULL COMMENT 'Edition Code used for lookups. Must be unique',
	VersionId int NOT NULL COMMENT 'Version of the Edition',
	YearPublished smallint NOT NULL COMMENT 'Year the Edition was first published in its entirety',
	Subtitle varchar(128) CHARACTER SET utf8 NULL COMMENT 'Subtitle for the Edition, esp. if different than Version (i.e. Second Edition)',
	PRIMARY KEY (Id),
...
CREATE TABLE IF NOT EXISTS Resources (
	...
	EditionId int NULL COMMENT 'Optional Edition of the Resource',
...
CREATE TABLE IF NOT EXISTS Bibles (
	...
	EditionId int NULL COMMENT 'Optional Edition of this Bible',
	YearPublished smallint NULL COMMENT 'Year this Bible (or Edition) was published',
...
CREATE TABLE IF NOT EXISTS VersionNotes (
	...
	EditionId int NULL COMMENT 'Optional Edition for this Note -- for notes specific to an Edition',
